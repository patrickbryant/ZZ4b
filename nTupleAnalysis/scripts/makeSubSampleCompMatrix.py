...
for y in ["2018","2017","2016"]:
    ...
    for i in range(20):
        ...
        for j in range(20):
            if j > i: 
                nEventsFile1, nEventsFile2, nEventsIn1not2, nEventsIn2not1 = getEventDiffs(eosPath+"data"+y+"_30_v"+str(i)+"/hists_3bSubSampled_30_v"+str(i)+".root",
                                                                                           eosPath+"data"+y+"_30_v"+str(j)+"/hists_3bSubSampled_30_v"+str(j)+".root")
