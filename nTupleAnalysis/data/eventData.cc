...
TH2F* eventData::getSRvsSB_PullHist(int lowBinEdge_ind, int lowBinEdge){

  // float m4jBinIndex = 300 + lowBinEdge_ind * 50; // m4jBinIndex holds mass  
  
  if(threeTag)
    return (TH2F*)SRvsSB_pullFile3b->Get(Form("leadSt_m_vs_sublSt_m_%d", static_cast<int>(lowBinEdge)));
